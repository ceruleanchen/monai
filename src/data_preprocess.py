...
def data_preprocess_for_training(dataset_dir_list, imagesTr_dir, labelsTr_dir, slicesTr_dir, scale_min=float('inf'), scale_max=float('-inf')):
    # makedirs
...
if __name__ == '__main__':
    # Prepare train_data
    dataset_dir_list = [os.path.join(config['monai_dataset_dir'], 'train_data'),
                        os.path.join(config['monai_dataset_dir'], 'retrain_data')]
    ...
    scale_min, scale_max = data_preprocess_for_training(dataset_dir_list, imagesTr_dir, labelsTr_dir, slicesTr_dir)

    # Prepare val_data
    dataset_dir_list = [os.path.join(config['monai_dataset_dir'], 'val_data'),
                        os.path.join(config['monai_dataset_dir'], 'retrain_data')]
    ...
    data_preprocess_for_training(dataset_dir_list, imagesTr_dir, labelsTr_dir, slicesTr_dir, scale_min, scale_max)
